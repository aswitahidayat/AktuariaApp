        ...
        $.get("{{ route('order.index') }}" +`/${id}/edit`, (data) => {
            ...
            $.ajax({
                ...
                success: function (datas) {
                    ...
                    $(`#ordhdr_program`).html(varHtml);
                    $("#ordhdr_program").val(data.ordhdr_program);
                },
                error: function (data) {
            ...
            $.ajax({
                ...
                success: function (datas) {
                    ...
                    $(`#ordhdr_service_hdr`).html(varHtml);
                    $("#ordhdr_service_hdr").val(data.ordhdr_service_hdr);
                },
                error: function (data) {
                    console.log('Error:', data);
                    // $(`#modal${module}`).modal('show');
