...
<div class="main-content">
 <div class="main-content-inner">
    ...
    <div class="page-content">
        ...
        <form id="formSearchMenu" action="javascript:void(0);">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">Menu Name:</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8 pb-20">
                            <a href="#" id="createMenu" class="btn btn-info btn-sm"><i class="ace-icon fa fa-plus small"></i> Add Menu</a>
...
@include('datamaster.menu.menuform') 
<!-- End modal registration form -->
@endsection

@section('js')
@include('datamaster.menu.menuscript') 
