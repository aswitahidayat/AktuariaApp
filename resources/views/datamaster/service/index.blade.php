            ...
            <div class="page-content">
                ...
                <div class="nav-search" id="nav-search">
								...
								<span class="input-icon">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#AddServiceModal" class="btn btn-info btn-sm"><i class="ace-icon fa fa-plus small"></i> Add Order Service</a>
								</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title blue lighter bigger bolder" id="AddUserTypeModalLabel"><i class="ace-icon fa fa-balance-scale cyan"></i> | New Order Service</h4>
                </div>
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-name" placeholder="999.999.999">
                        </div>
                        <div class="form-group">
