<div class="modal fade" id="modalOrderService"  role="dialog" aria-labelledby="AddServiceModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title blue lighter bigger bolder" id="modelHeadingOrderService"><i class="ace-icon fa fa-balance-scale cyan"></i> | New Order Service</h4>
            </div>
            <div class="modal-body">
                <form id="formOrderService" name="formOrderService">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="saveBtnOrderService" class="btn btn-primary"><i class="ace-icon fa fa-save bigger-110"></i>Save</button>
            </div>
        </div>
    </div>
</div>