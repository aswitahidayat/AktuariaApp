            ...
            <form id="formService" name="formService">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ordsrvhdr_name" name="ordsrvhdr_name" required>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label bolder">Description:</label>
                        <textarea class="form-control" id="ordsrvhdr_desc" name="ordsrvhdr_desc" required></textarea>
                    </div>
                    {{-- <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="saveBtnService" class="btn btn-primary"><i class="ace-icon fa fa-save bigger-110"></i>Save</button>
                </div>
            </form>
        </div>
    </div>
